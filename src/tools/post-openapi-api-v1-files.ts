...
export const tinkoffBusinessPostOpenapiApiV1FilesTool = {
  name: "tinkoff_business_post_openapi_api_v1_files",
  description: "Creates or submits files for the authenticated Tinkoff Business account. Docs: https://developer.tbank.ru/docs/api/post-api-v-1-files",
  inputSchema: {
