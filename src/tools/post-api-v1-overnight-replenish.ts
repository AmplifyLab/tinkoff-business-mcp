...
export const tinkoffBusinessPostApiV1OvernightReplenishTool = {
  name: "tinkoff_business_post_api_v1_overnight_replenish",
  description: "Creates or submits overnight replenish for the authenticated Tinkoff Business account. Docs: https://developer.tbank.ru/docs/api/post-api-v-1-overnight-replenish",
  inputSchema: {
  ...
  cb: async ({
    ...
    const resolvedUrl = `${TINKOFF_BUSINESS_SECURED_OPENAPI_BASE_URL}/v1/overnight/replenish`;
