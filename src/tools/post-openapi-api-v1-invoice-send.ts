...
export const tinkoffBusinessPostOpenapiApiV1InvoiceSendTool = {
  name: "tinkoff_business_post_openapi_api_v1_invoice_send",
  description: "Creates or submits invoice send for the authenticated Tinkoff Business account. Docs: https://developer.tbank.ru/docs/api/post-api-v-1-invoice-send",
  inputSchema: {
  ...
  cb: async ({
    ...
    const resolvedUrl = `${TINKOFF_BUSINESS_OPENAPI_BASE_URL}/v1/invoice/send`;
