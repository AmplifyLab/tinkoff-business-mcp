...
export const tinkoffBusinessPostOpenapiApiV1PaymentCreateTool = {
  name: "tinkoff_business_post_openapi_api_v1_payment_create",
  description: "Creates or submits payment creation for the authenticated Tinkoff Business account. Docs: https://developer.tbank.ru/docs/api/post-api-v-1-payment-create",
  inputSchema: {
  ...
  cb: async ({
    ...
    const resolvedUrl = `${TINKOFF_BUSINESS_OPENAPI_BASE_URL}/v1/payment/create`;
