...
export const tinkoffBusinessPostApiV1DeliveryDocumentsTool = {
  name: "tinkoff_business_post_api_v1_delivery_documents",
  description: "Creates or submits delivery documents for the authenticated Tinkoff Business account. Docs: https://developer.tbank.ru/docs/api/post-api-v-1-delivery-documents",
  inputSchema: {
  ...
  cb: async ({
    ...
    const resolvedUrl = `${TINKOFF_BUSINESS_SECURED_OPENAPI_BASE_URL}/v1/delivery/documents`;
