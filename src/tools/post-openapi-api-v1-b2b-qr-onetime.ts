...
export const tinkoffBusinessPostOpenapiApiV1B2bQrOnetimeTool = {
  name: "tinkoff_business_post_openapi_api_v1_b2b_qr_onetime",
  description: "Creates or submits B2B QR onetime for the authenticated Tinkoff Business account. Docs: https://developer.tbank.ru/docs/api/post-api-v-1-b-2-b-qr-onetime",
  inputSchema: {
  ...
  cb: async ({
    ...
    const resolvedUrl = `${TINKOFF_BUSINESS_OPENAPI_BASE_URL}/v1/b2b/qr/onetime`;
